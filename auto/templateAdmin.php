...
<div class="sidenav">
  ...
  <button class="dropdown-btn"><i class="fas fa-laptop"></i> Ordinateurs

    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <a href="index.php?action=add_ordi"><i class="fa fa-plus" aria-hidden="true"></i> Ajout</a>
    <a href="index.php?action=list_ordi"><i class="fa fa-bars" aria-hidden="true"></i> Liste</a>
  </div>
